from src.train.train_sam_query_v1_0 import train_phase
...
def main():
    cfg = {
        "experiment_name": "nfl_sam_query_formation_classifier_v1_0",
        "experiment_description": (
            "Training classifier model for NFL formation detection "
            "using SAM + sam query and formation. Version 1.0."
        ),
        "experiment_goals": [
